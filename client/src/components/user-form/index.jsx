...
const UserForm = () => {
    ...
    const { handleSubmit, handleChange, values, errors, touched } = useFormik({
      ...
      onSubmit: (values, { resetForm }) => {
         axios.post("http://localhost:8080/users", values).then(() => resetForm());
      },
   });
  return (
    <div id="product-form">
         ...
         <form id="product-form" onSubmit={handleSubmit}>
            ...
            {errors.firstName && touched.firstName && (
               <span style={{ color: "red", fontSize: "16px" }}>{errors.firstName}</span>
            )}
            <br />
            ...
            {errors.lastName && touched.lastName && (
               <span style={{ color: "red", fontSize: "16px" }}>{errors.lastName}</span>
            )}
            <br />
            ...
            {errors.birthDate && touched.birthDate && (
               <span style={{ color: "red", fontSize: "16px" }}>{errors.birthDate}</span>
            )}
            <br />
